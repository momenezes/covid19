...
scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +  expand_limits(x = 10) +
...
plotly::layout(dragmode = "zoom", xaxis = list(showticklabels = FALSE), yaxis = list(showticklabels = FALSE)) %>%
