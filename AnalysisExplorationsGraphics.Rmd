...
ccc$Country <- stri_replace_all_fixed(ccc$Country,"Bahamas, The","Bahamas", vectorize_all = TRUE)
# [26] "Bolivia"                                             
# [27] "Bolivia (Plurinational State of)"
...
#[270] "United States"                                       
#[271] "United States of America"                            
jhucovid19$Country <- stri_replace_all_regex(jhucovid19$Country, "United States.*", "United States of America", vectorize_all = TRUE)
ccc$Country <- stri_replace_all_regex(ccc$Country, "United States.*", "United States of America", vectorize_all = TRUE)
...
```{r}
filter(jhucovid19, Country %in% c("Italy", "Brazil", "France", "Spain", "Germany", "Japan","US", "Argentina","Chile")) %>% 
  filter(ConfirmedCases >= 30 ) %>% 
